        ...
        <div className="lg:pl-72">
          ...
          <main className="py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              <Routes>
                  <Route path='/MLTs' element={<MLT/>}></Route>
                  <Route path='/PHIs' element={<PHI/>}></Route>
                  <Route path="/MOHSupervisors" element={<MOHSupervisor/>}></Route>
                  <Route path='/MOHAreas' element={<MOHArea/>}></Route>
                  <Route path='/PHIAreas' element={<PHIArea/>}></Route>
                  <Route path='/Laboratories' element={<Laboratory/>}></Route>
              </Routes>
            </div>
          </main>
        </div>
