...
function HeroSection() {
    return (
        <>
            <section id="hero" className="bg-blue-900 text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <a href="#services" className="bg-white text-blue-900 py-3 px-6 rounded-full font-semibold">Our Services</a>
                </div>
            </section>
        </>
    );
